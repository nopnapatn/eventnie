    ...
    <div class="max-w-3xl mx-auto p-4">
        ...
        <form action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="max_attendees" id="max_attendees" class="w-full p-2 border rounded" required min="1">
            </div>            
            ...
            <div class="mb-4">
                ...
                <input type="datetime-local" name="end_at" id="end_at" class="w-full p-2 border rounded" required>
            </div>

            <div class="mb-4">
                <label for="image" class="block text-lg font-semibold mb-2">Event Image</label>
                <input type="file" name="image" id="image" class="p-2 border rounded" accept="image/*" required>
            </div>
