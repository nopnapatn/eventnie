...
<section class="flex">
    ...
    <div class="px-16 w-full">
        ...
        <!-- section 2 -->
        <div class="rounded-lg opacity-90 h-96 px-48">
            <div class="flex justify-around h-full w-full">
                <div class="flex h-full w-full">
                    <img src="{{ asset('storage/' . $event->image_path) }}" alt="Event Image" class="bg-cover bg-center shadow-xl">
                </div>
                <div class="h-full w-full px-8 py-8">
                    <span class="font-semibold text-4xl text-black">{{ $event->title }}</span><br><br>
                    <span class="text-black">Mon, 27 Jan 2023</span><br>
                    <span class="text-red-400 text-xs">1 day left!</span><br><br>
                    <button class="bg-black rounded-lg h-10 w-24">Join Event</button>
                </div>
            </div>
        </div>
