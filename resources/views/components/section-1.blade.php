            ...
            <form class="w-full">
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none">
                        <svg class="h-4 text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 20 20">
                    ...
                    <input type="search" id="default-search"
                        class="block w-full pl-10 text-sm text-gray-900 rounded-lg bg-gray-50 focus:ring-black focus:border-black"
...
<div class="flex items-center py-4 pb-8">
    <ul class="flex flex-row font-medium mt-0 mr-6 space-x-8 text-sm">
        ...
        @if (auth()->check())
            <li>
                <a href="{{ route('events.user_events') }}" class="text-gray-900 hover:underline">My Events</a>
            </li>
        @endif
