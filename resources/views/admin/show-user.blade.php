...
<section>
    <div class="max-w-4xl mx-auto p-8">
        ...
        <div class="mb-8 border-4 border-black rounded-lg shadow-md p-6">
            ...
            <img src="{{ asset('storage/' . $user->profile_picture) }}" alt="Profile Picture" class="w-32 h-32 rounded-full mt-4">
        </div>
